Public Class Contabilidad_DialogoOrdenPago
    ...
    Public Sub Cargardatosamodificar(ByVal ORDENPAGOS As Ordendepago, ByVal NUEVO As Boolean)
        ...
        NOVALIDO_CHECKBOX.Checked = ORDENPAGO.novalido
        If OPparamodificar Then
        ...
        'ASIGNACIÓN DE FORMATO DE LAS COLUMNAS
    ...
    Private Sub guardardatosOP()
        ...
        ORDENPAGO.ordenpago_Detalle2 = ordenpago_detalles2.Text
        ...
        ORDENPAGO.novalido = NOVALIDO_CHECKBOX.Checked
        ORDENPAGO.Partida_datatable = CType(Datos_Partidas.DataSource, DataTable)
        'Borrado de partidas cuyo valor de importe sea 0 (cero) o dbnull
    ...
    Private Function ADVERTENCIA_COHERENCIA() As String
        ...
        If NUEVAOP Then
            ...
            End If
        End If
        If Not ORDENPAGO.novalido Then
    ...
    Private Sub Datos_ordenpago_KeyPress(sender As Flicker_Datagridview, e As KeyPressEventArgs) Handles Datos_Partidas.KeyPress
        'If Not (Char.IsDigit(CChar(CStr(e.KeyChar))) Or e.KeyChar = "," Or e.KeyChar = ".") Then
        '    e.Handled = True
        'Else
        If sender.CurrentCell.Value.GetType.ToString = "System.Decimal" Then
            If e.KeyChar = "." Then
                e.KeyChar = ","
            End If
        End If
            ...
            Select Case e.KeyCode
                Case Is = Keys.Delete
                    Select Case Datos_Ordenesprovision.SelectionMode
                        Case Is = 1 'full row
                            For Each DataGridViewRow As DataGridViewRow In Datos_Ordenesprovision.SelectedRows
    ...
    Private Sub NOVALIDO_CHECKBOX_CheckedChanged(sender As Object, e As EventArgs) Handles NOVALIDO_CHECKBOX.CheckedChanged
        ORDENPAGO.novalido = NOVALIDO_CHECKBOX.Checked
    End Sub
    ...
    Private Sub CARGAR_PARTIDAS_SUGERIDAS()
        ...
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "01", "031", "001", "03120", "0-01", 0})
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "01", "012", "234", "01220", "0-01", 0})
        '    Case Is = "RENDICIÓN"
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "01", "012", "230", "01220", "0-05", 0})
        '        datos.Rows.Add({"06", "15", "0", "3", "10", "1", "01", "012", "230", "01220", "", 0})
        '    Case Is = "RENDICIÓN FINAL"
        '    Case Is = "RENDICIÓN PARCIAL"
        '    Case Is = "RECONOCIMIENTO"
        '        datos.Rows.Add({"06", "01", "2-03", "3", "10", "1", "01", "012", "227", "01220", "", 0})
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "01", "012", "232", "01220", "0-01", 0})
        '        datos.Rows.Add({"06", "01", "2-03", "3", "10", "1", "01", "012", "230", "01220", "", 0})
        '    Case Is = "RECONOCIMIENTO Y REAPROPIACIÓN"
        '    Case Is = "VIÁTICOS"
        '    Case Is = "REPOSICIÓN"
        '    Case Is = "CONTRATOS"
        '    Case Is = "BECAS"
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "03", "031", "", "03160", "0-02", 0})
        '        datos.Rows.Add({"06", "01", "0", "3", "10", "1", "03", "031", "601", "03160", "0-02", 0})
